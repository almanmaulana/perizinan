    ...
    <div class="max-w-3xl mx-auto mt-10 bg-white dark:bg-[#2a2a2a] shadow-lg rounded-2xl p-6 transition duration-300">
        ...
        <div class="flex items-center justify-between mb-6">
            ...
            <h1 class="text-2xl font-bold text-gray-800 dark:text-gray-100">
                <i class="fa-solid fa-user-plus text-blue-500 mr-2"></i> Tambah User
            </h1>
        </div>
        ...
        <form method="POST" action="{{ route('users.store') }}" enctype="multipart/form-data" class="space-y-4">
            ...
            <div class="mt-3">
                ...
                <input type="file" name="foto" 
                    class="mt-1 w-full px-3 py-2 rounded-lg 
                        border border-gray-300 dark:border-gray-600 
                        bg-white text-gray-800 dark:bg-[#3a3a3a] dark:text-gray-100
                        focus:ring-2 focus:ring-blue-400 transition">
            </div>
